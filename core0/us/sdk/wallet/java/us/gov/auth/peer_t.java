...
public abstract class peer_t extends us.gov.id.peer_t implements api {
    ...
    public void verification_completed(final pport_t rpport, final pin_t pin) {
        ...
        if (!authorize(pubkey, pin)) {
            return;
        }
        stage = stage_t.authorized;
    }

    public abstract boolean authorize(final PublicKey pub, final pin_t pin);

    @Override public boolean process_work(datagram d) {
        switch (d.service.value) {
            //#include <us/api/generated/java/gov/auth/hdlr_svc-router>
            //------------------------------------------------------------__begin__------generated by configure, do not edit.
            //content of file: <us/api/generated/java/gov/auth/hdlr_svc-router>
    ...
    //#include <us/api/generated/java/gov/auth/hdlr_svc_handler-impl>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/java/gov/auth/hdlr_svc_handler-impl>
    // auth - master file: us/api/data/gov/auth
    ...
    //------------------apitool - API Spec defined @ us/api/generated/java/gov/auth/hdlr_local-impl
    ...
    //#include <us/api/generated/java/gov/auth/cllr_rpc-impl>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/java/gov/auth/cllr_rpc-impl>
