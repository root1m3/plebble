...
public abstract class rpc_peer_t extends us.gov.relay.rpc_peer_t implements caller_api {
    ...
    //#include <us/api/generated/java/wallet/engine/cllr_rpc-impl>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/java/wallet/engine/cllr_rpc-impl>
    ...
    //#include <us/api/generated/java/wallet/pairing/cllr_rpc-impl>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/java/wallet/pairing/cllr_rpc-impl>
    ...
    //-/----------------------------------------------------------___end___------generated by configure, do not edit.
    //#include <us/api/generated/java/wallet/r2r/cllr_rpc-impl>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/java/wallet/r2r/cllr_rpc-impl>
    ...
    //-/----------------------------------------------------------___end___------generated by configure, do not edit.
    //#include <us/api/generated/java/wallet/wallet/cllr_rpc-impl>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/java/wallet/wallet/cllr_rpc-impl>
    ...
    @Override public ko call_track(final uint64_t ts) {
        log("track "); //--strip
        return send1(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_track), new seq_t(0), ts));
    }

    @Override public ko call_track_pay(final blob_t blob_tx, track_pay_out_dst_t o_out) {
        log("track_pay "); //--strip
        /// out:
        ///    blob_t blob_tx;
        ///    string progress;
        ...
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_track_pay), new seq_t(0), blob_tx), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_track_pay_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_track_pay_response + " got " + d_in.service.value); //--strip
            return r;
        }
        ko r = blob_reader_t.readD(d_in, o_out);
        return r;
    ...
    @Override public ko call_track_relay(final blob_t blob_tx, string progress) {
        log("track_relay "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_track_relay), new seq_t(0), blob_tx), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_track_relay_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_track_relay_response + " got " + d_in.service.value); //--strip
            return r;
        }
        ko r = blob_reader_t.readD(d_in, progress);
        return r;
    }
